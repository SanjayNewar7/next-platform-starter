              ...
              <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                <CardHeader className="px-0 pt-0">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <CardTitle className="text-3xl md:text-4xl font-headline text-foreground">About MeroSathi</CardTitle>
                  </div>
                </CardHeader>
                <CardContent className="px-0 pb-0 space-y-5 text-foreground/80 text-lg leading-relaxed">
                  <p>
                    MeroSathi is dedicated to empowering individuals, particularly within the Nepali context, to understand, establish, and uphold healthy personal boundaries. We believe that clear boundaries are fundamental to well-being, fostering respectful relationships and personal growth.
                  </p>
                  <p>
                  ...
                  <p>
                    Our vision is a community where individuals feel confident, respected, and empowered in all their interactions, leading to more fulfilling lives. MeroSathi aims to be a supportive companion on this journey of self-discovery and empowerment.
                  </p>
                </CardContent>
              </div>
            </div>
